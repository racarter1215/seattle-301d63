...
// Student {name: "Joe", age: "Schmoe", hometown: 100}. Basically, the constructor working correctly
// 2. What is "this" when joe.scopeArrow() is invoked?
// Window {parent: Window, opener: null, top: Window, length: 0, frames: Window, …}. Basically a blank template of everything that could possibly be inside a constuctor
// 3. Explain why "this" is different when an arrow function is used.
// It's different because the arrow functions do not have an inherent 'this', and are therefore not suitable for use in constructor functions.
